...
public class JsonUtils {
    ...
    public static Sandwich parseSandwichJson(String json) {
        ...
        try {
            ...
            String placeOdOrigin = jsonObject.getString(KEY_PLACE_OF_ORIGIN);
            ...
            sandwich = new Sandwich(mainName, alsoKnownAs, placeOdOrigin, description, imageUrl, ingredients);
        }
